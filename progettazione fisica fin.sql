...
citta varchar(128) null) engine = innodb;
alter table studente
add column cognome varchar (64) not null;
...
add column cognome varchar(64) not null;
alter table docente 
add column corso varchar(64) not null;
create table corso
(codice int,
nome varchar(128) null,
...
alter table partecipa_corsomaster add data_pub date;
alter table partecipa_corsomaster drop data_pub;
...
(2309,'franco'),
(2420,'duwo');
insert into docente(cognome,corso)
values ('park','cybersecurity'),
('xin','web developer'),
('rossi','cloud engineer'),
('bruni','java'),
('gomez','sq'),
('swift','mongol'),
('mercury','phyton'),
('anderson','javascript'),
('kvitko','r'),
('demkovich','googlestudio'),
('raz','power bi'),
('cee','aws'),
('lee','microsoft azzure'),
('grant','mongoldb'),
('frank','cplus'),
('love','ion'),
('biden','html'),
